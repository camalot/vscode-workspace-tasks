...
Click the **compound task icon** next to any task to add it to a compound task. Compound tasks (queues) let you run multiple tasks in sequence—perfect for build, test, and deploy pipelines.
