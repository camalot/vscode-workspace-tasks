...
[→ Visual Studio Marketplace](https://marketplace.visualstudio.com/items?itemName=darthminos.workspace-tasks){: .btn .btn-success }
...
[→ Open VSX Registry](https://open-vsx.org/extension/darthminos/workspace-tasks){: .btn .btn-success }
