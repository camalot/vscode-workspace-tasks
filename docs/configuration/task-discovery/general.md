...
![Screenshot - Exclude Patterns]({{ '/configuration/exclude-patterns.png' | prepend: site.github_image_docs_url }})
...
![Screenshot - Fetch Depth]({{ '/configuration/fetch-depth.png' | prepend: site.github_image_docs_url }})
