...
![Running task ETA description]({{ '/features/task-duration-running-eta.png' | prepend: site.github_image_docs_url }})
...
<!-- screenshot placeholder -->
![Pre-run tooltip with duration estimate]({{ '/features/task-duration-tooltip.png' | prepend: site.github_image_docs_url }})
...
<!-- screenshot placeholder -->
![Typical Duration stat cell in the Statistics tab]({{ '/features/task-duration-stats-cell.png' | prepend: site.github_image_docs_url }})
