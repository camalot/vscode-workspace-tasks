...
The easiest way to report issues or request features is through the **GitHub Issues** interface directly from VS Code:
...
- **🔧 New Task/Tool Support** - Request support for additional task types or build tools

Each template includes helpful prompts to ensure we have all the information needed to address your request effectively.
...
- Relevant error messages or logs (View → Output → Workspace Tasks)
...
- **Extension Settings** - Browse available settings by searching for "Workspace Tasks" in VS Code's settings (Ctrl/Cmd + ,)
...
- 📝 **[Leaving a review](https://marketplace.visualstudio.com/items?itemName=darthminos.workspace-tasks)** on the VS Code Marketplace
- ☕ **[Supporting the developer](https://github.com/sponsors/camalot)** via GitHub Sponsors

## 🤝 Contributing

Interested in contributing code, documentation, or other improvements? Check out our **[Contributing Guidelines](CONTRIBUTING.md)** (if available) or feel free to:
